...
$chapters = Software::get_chapters_belonging_to(get_the_ID());
$last_updated_array = Chapter::get_last_updated_chapter($chapters);
$theme_url = get_template_directory_uri();

$software_title = get_the_title();
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            ?>
                                                <li><a href="#"><?php echo $version['name']; ?></a></li>
                                            <?php
                                            endforeach;
                                            ?>
                                        </ul>
                ...
                <div class="tutorial__content text intro">
                    <div class="tutorial__top">
                        ...
                        <div class="tutorial__bookmark-desktop">
                            <button class="setBookmarked" data-bookmarked="false">
