...
<section class="cards-with-categories">
    <div class="cards-with-categories__categories categories flex">
        <div class="categories__item">
            <span class="categories__bg"></span>
            <a href="#">Bachelor</a>
            <span class="categories__text"><span>Bachelor</span></span>
        </div>
        <div class="categories__item categories__item--active">
            <span class="categories__bg"></span>
            <a href="#">Master</a>
            <span class="categories__text"><span>Master</span></span>
        </div>
        <div class="categories__item">
            <span class="categories__bg"></span>
            <a href="#">Minor</a>
            <span class="categories__text"><span>Minor</span></span>
        </div>
    </div>
