...
class Gutenberg_ACF {
    ...
    private const TEXT_IMAGE_BLOCK = [
        ...
        'fields' => array(
            ...
            array(
                'key' => 'tu-delft-text-image_has_image_zoom_key',
                'label' => 'Has Image Zoom',
                'name' => 'tu-delft-text-image_has_image_zoom',
                'aria-label' => '',
                'type' => 'true_false',
    ...
    private const DOUBLE_IMAGE_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-double-image_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-double-image_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'tu-delft-double-image_image-left_key',
                'label' => 'Image',
                'name' => 'tu-delft-double-image_image-left',
                'aria-label' => '',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'tu-delft-double-image_image-right_key',
                'label' => 'Image',
                'name' => 'tu-delft-double-image_image-right',
                'aria-label' => '',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'tu-delft-double-image-left_has_image_zoom_key',
                'label' => 'Has Image Zoom (image left)',
        ...
        'location' => array(
            array(
                array(
                    'param' => 'block',
                    'operator' => '==',
                    'value' => 'acf/tu-delft-double-image',
                ),
            ),
        ),
        'menu_order' => 1,
        ...
        'hide_on_screen' => '',
        'active' => true,
        'description' => 'TU Delft Gutenberg Content for Double Image Block',
        'show_in_rest' => 0,
    ];
    ...
    private const IMAGE_TEXT_BLOCK = [
		...
		'fields' => array(
            ...
            array(
                'key' => 'tu-delft-image-text_has_image_zoom_key',
                'label' => 'Has Image Zoom',
                'name' => 'tu-delft-image-text_has_image_zoom',
                'aria-label' => '',
                'type' => 'true_false',
                'instructions' => 'Check if you want to enable image zoom',
                'required' => 0,
    ...
    private const IMAGE_BLOCK = [
        ...
        'fields' => array(
            ...
            array(
                'key' => 'tu-delft-image_has_image_zoom_key',
                'label' => 'Has Image Zoom',
                'name' => 'tu-delft-image_has_image_zoom',
                'aria-label' => '',
                'type' => 'true_false',
                'instructions' => 'Check if you want to enable image zoom',
                'required' => 0,
