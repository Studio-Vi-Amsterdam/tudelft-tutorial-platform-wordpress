...
class Gutenberg_ACF {
    ...
    private const TEXT_BLOCK = [
		...
		'fields' => array(
            array(
                'key' => 'tu-delft-text_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-text_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const TEXT_IMAGE_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-text-image_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-text-image_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const IMAGE_TEXT_BLOCK = [
		...
		'fields' => array(
            array(
                'key' => 'tu-delft-image-text_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-image-text_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const IMAGE_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-image_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-image_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const VIDEO_BLOCK = [
		...
		'fields' => array(
            array(
                'key' => 'tu-delft-video_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-video_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const TEXT_VIDEO_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-text-video_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-text-video_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const VIDEO_TEXT_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-video-text_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-video-text_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const INFO_BLOCK = [
		...
		'fields' => array(
            array(
                'key' => 'tu-delft-info-box_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-info-box_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const CONTENT_CARD_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-content-card_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-content-card_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const QUIZ_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-quiz_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-quiz_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
    ...
    private const H5P_BLOCK = [
        ...
        'fields' => array(
            array(
                'key' => 'tu-delft-h5p_title_key',
                'label' => 'Title',
                'name' => 'tu-delft-h5p_title',
                'aria-label' => '',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
